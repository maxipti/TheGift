                        ...
                        <div class="card-body d-flex justify-content-between flex-column">
                            ...
                            <div>
                                ...
                                <p class="card-text d-flex justify-content-between mt-2">
                                    <small class="text-success">${convertWeiToNas(+project.collected)} NAS collected</small>
                                    <small class="text-muted">Goal: ${convertWeiToNas(+project.goal)} NAS</small>
                                </p>
                                <p class="card-text">
...
function getDaysGoes(unixStamp) {
    ...
    if (diffDays > 0) {
        return `Goes ${diffDays} days`;
    }

    if (diffHrs > 0) {
        return `Goes ${diffHrs} hours`;
    }

    return `Goes ${diffMins} minutes`;
}
